package com.S.dailyread.Utility;
...
/**
 * 自定义常量，用来获取ImageLoader实例和DisplayImageOtions对象
 */
...
public class Constant {
    ...
    public static DisplayImageOptions getDisplayImageOptions() {
        return new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.default_image) //设置图片在下载期间显示的默认图片
                .showImageForEmptyUri(R.drawable.default_image)//设置图片Uri为空或是错误的时候显示默认的图片
